module.exports={
  ...
  About:{
    ...
    commun1:'Host community:',
    commun2:'Open Source Workshop',
    school1:'Undertake school:',
    school2:'College of Big Data and Software, Chongqing University',
    place:'Meeting Location:',
    place1:'Democratic Lake Auditorium, area A, Chongqing University',
  ...
  AboutUs:{
    ...
    about6:'Volunteer team',
    about7:'Propaganda team',
    about8:'Sponsorship team',
 ...
 Apply:{
  ...
  Agenda:{
   /* title1:'conference agenda',*/
    ...
    main:'The main venue',
    other1:'Session venue A(504 of main teaching buliding)',
    other2:'Session venue B(506 of main teaching building)',
  ...
  Agenda10: {
    ...
    process4: 'Speech: Opening speech by Liu Yuming of CQU',
    process5: 'Rest',
    ...
    process27:'Graduation Ceremony',
    process28:'Speach: the beauty of pure open source, interesting, rich in content, meaningful by Li Yongjian of CQUPT',
    process29:'Speach: experience of application for GSoC by Liu Jiahui of XUPT',
    speach1: 'Dean Xiong',
    ...
    speach18: 'Wang Zibo(Hypercube)',
    speach19: 'University of Science and Technology of China',
    speach20: 'Speech Content: From a course project to a college student innovation project, we spent a year and a half developing and improving this open-source-hardware-based 3D vision solution, making a cheap grating become a naked-eye 3D display. I will introduce the whole process from background research and feasibility demonstration to software development and deployment, hoping to help you on your own project, and find those who are interested in this project.',
    ...
    speach29: 'If you have intention in Lighting Speech, please go to the assigned place near the venue to sign up in advance. And registration is available on the whole day of June 10th',
    ...
    speach49:'workshop by Cheng Sijie',
    speach50:'We are here hosting a short graduation ceremony for all soon-to-graduate participants, meanwhile we’d like to thank the members who have done great contributions for SOSCON during the preparations.',
    speach51:'Ma Yuze',
    speach52:'Rensselaer Polytechnic Institute',
    speach53:'The main contents of the speech include the following four points:',
    speach54:'1. how do we put the open source education into effect in North America',
    speach55:'2. the advantages and disadvantages of the open source education',
    speach56:'3. some common tools',
    speach57:'4. YACS, a program helps to “threaten” your professors',
    speach58:'Honored Guest: Yuze Ma(Chinese name: 马渝泽，GitHub ID: bobmayuze), Male, ailurophile. A junior student from the school of IT& Web Science, Rensselaer Polytechnic Institute and representative from ITWS student leadership association. Gamma Nu Eta member. Rensselaer Center of Open Source mentor. Fond of varieties of hilarious actions and funny projects. At present, a data engineer from the AI Lab of CODEMAO, a Chinese unicorn in the field of online education. ',
    speach59:'Li Yongjian',
    speach60:'Chongqing University of Posts and Telecommunications',
    speach61:'Honored Guest: Li Yongjian (Jason), Chongqing University of Posts and Telecommunications(CQUPT), is currently one of the volunteers of LinuxStory, the President of Hardware Technology and Application Association of CQUPT, love open-source hardware and software, and like to do some little projects of open source hardware at ordinary times.',
    speach62:'Speach content: LinuxStory the beauty of pure open source, interesting, rich in content, meaningful LinuxStory found in 2011 think of carrying forward pure open source culture and promoting open source technology as its own tasks, adhere to the operation of community in a nonprofit model, is one of the largest nonprofit open source stations in China. ',
    speach63:'Liu Jiahui',
    speach64:'Xi\'an University of Posts and Telecommunications',
    speach65:'Honored Guest: Guest Introduction: Liu Jiahui, the vice-leader of the Linux Hobby Group, is currently participating the Google Summer of Code 2018, have sumitted some patches to Gnome, like eating hot-pot and photography.',
    ...
    speach67:'Dai Xiaodai',
    speach68:'Beijing University of Posts and Telecommunications',
    speach69:'Concerned about the direction of computer vision and data mining, hobbyist Hackathon\'s alchemists.',
    speach70:'Deep learning framework is the first choice when you would like to prototype, research or develop artificial intelligence related algorithm. We will start with a brief survey on popular  frameworks, and end up with discussing what can a student or independent developer do in the open source community.',
    speach71:'Yin Ting(Helen)',
    speach72:'Open source workshop',
    speach73:'Honored Guest: Not yet',
    speach74:'Speech content: Not yet',
    ...
    speakers5:'Honored Guest: Zibo Wang, CTO of USTC LUG',
    ...
    workshop1:'principal speaker and student developer',
    workshop2:'Lin Weijie',
    workshop3:'NEO ，community developer，Nanyang Technological University(NTU)，contributor in NEO Blockchain Community',
    workshop4:'NEO is a kind of distributed network to realize"intelligent economy" through the digitalization of assets using blockchain technique and digital identity and automate of assets management utilizing intelligent agreement. ',
    workshop5:'NEO is an unprofitable blockchain program of communilization.Using blockchain technology and digital identity to realize digital asset. Using intelligent contract to realize autonmic management of digital asset. Achieving the network of intelligent ecoomy. NEO was formally set in 2014 and opened source in real time in Github in Juln in 2015. Github URL: https://github.com/neo-project',
