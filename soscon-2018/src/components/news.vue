  ...
  <div class="Background">
    <div class="workers">
      <div style="display: inline-block;text-align: center;margin-top: 7%">
        <h4 style="background-color: black;color: white;padding: 20px 20px;margin: 0;">{{$t("News.title1")}}</h4>
      </div>
      <p class="group" style="margin-top: 40px">————</p>
      <div style="height: 400px;overflow: auto">
        <div class="News">
          <h6 class="NewsTitle">{{$t("News.newstitle1")}}</h6>
          <p class="NewsContent">{{$t("News.newscontent1")}}</p>
          <p class="NewsTime">{{$t("News.newstime1")}}</p>
        </div>
        <hr/>
      </div>
    </div>
